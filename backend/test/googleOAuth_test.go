...
func TestGoogleOAuthUserExists(t *testing.T) {
...
func TestGoogleOauthUserExistsWithoutIdentity(t *testing.T) {
	userRepo := &FakeUserRepository{
		users: []core.User{
			{
				ID: "user_id",
...
func TestGoogleOauthUserNotExistsWithEmailSuccess(t *testing.T) {
	userRepo := &FakeUserRepository{
		users: []core.User{},
	}
